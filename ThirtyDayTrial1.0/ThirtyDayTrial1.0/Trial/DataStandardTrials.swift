...
class DataStandardTrials: NSObject {
    ...
    class func createList()  -> [TrialPeriod] {
        ...
        return [TrialPeriod(trialName: "HBO", startDate: currentDate, daysToEndDate: range.count, cancellationTime: plusOneMonth), TrialPeriod(trialName: "NetFlix", startDate: currentDate, daysToEndDate: range.count, cancellationTime: plusOneMonth)]
    }
